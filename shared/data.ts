...
const studentNames = [
  ...
  "Ethan Miller", "Sophia Moore", "Mason Taylor", "Isabella Anderson", "William Thomas",
  "Mia Jackson", "James White", "Charlotte Harris", "Benjamin Martin", "Amelia Thompson",
  "Lucas Garcia", "Harper Martinez", "Henry Robinson", "Evelyn Clark", "Alexander Rodriguez",
  "Abigail Lewis", "Michael Lee", "Emily Walker", "Daniel Hall", "Elizabeth Allen",
  "Matthew Young", "Sofia Hernandez", "Joseph King", "Avery Wright", "Samuel Lopez",
  "Ella Hill", "David Scott", "Scarlett Green", "Carter Adams", "Victoria Baker",
  "Wyatt Gonzalez", "Grace Nelson", "Owen Carter", "Chloe Mitchell", "Luke Perez",
  "Zoey Roberts", "Gabriel Turner", "Penelope Phillips", "Anthony Campbell", "Layla Parker",
  "Isaac Evans", "Riley Edwards", "Dylan Collins", "Aria Stewart", "Nathan Sanchez"
];

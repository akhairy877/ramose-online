...
import { visionBoardData, subjects, updateMilestoneStatus, updateStudentCareerGoal, updateMilestoneCareerRelevance, updateMilestoneUsedAttempts, updateQuizAttemptScore, getCurrentVisionBoardData } from '@shared/data';
